...
def add_pyramid(polygons, x, y, z, width, height, depth):
    ...
    #left
    add_polygon(polygons, cx, cy, cz, x, y, z1, x, y, z)
    #back
    add_polygon(polygons, cx, cy, cz, x1, y, z1, x, y, z1)
    #right
    add_polygon(polygons, cx, cy, cz, x1, y, z, x1, y, z1)
    #front
    add_polygon(polygons, cx, cy, cz, x, y, z, x1, y, z)
...
def add_cylinder(polygons, cx, cy, cz, r, h, step):
    ...
    p = len(top) - 1
    add_polygon(polygons,
                top[p][0], top[p][1], top[p][2],
                cx, cy, cz,
                top[0][0], top[0][1], top[0][2])
    add_polygon(polygons,
                cx, cy - h, cz,
                bottom[p][0], bottom[p][1], bottom[p][2],
